    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form commandName="indvdlSchdulManageVO" action="${pageContext.request.contextPath}/cop/smt/sim/ParkManageRegistActor.do" name="indvdlSchdulManageVO" method="post" enctype="multipart/form-data">
